...
INSERT INTO band (id, name, type, country, city, isactive) VALUES (1, 'dudzioki', 'metallica', 'niemcy', 'berlin', true);
INSERT INTO band (id, name, type, country, city, isactive) VALUES (2, 'metallica', 'metal', 'USA', 'los angeles', true);
INSERT INTO band (id, name, type, country, city, isactive) VALUES (3, 'paryta', 'melodic black metal', 'polska', 'piwniczna', false);
